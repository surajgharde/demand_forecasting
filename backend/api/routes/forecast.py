...
[Option A] Database dependency removed — no Postgres/SQLite required.
The background insight-writing task has been dropped; forecasting
still works fully and all core endpoints are intact.
"""
import io
import traceback
import numpy as np
...
async def upload_and_forecast(
    ...
    try:
        ...
        # [Option A] Background DB task removed — no database dependency.
        # Forecasting still works fully without it.
